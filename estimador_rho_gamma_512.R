...
# save(dados_512_1000, file = "dados_512_1000")

load("dados_512_1000")
dados<-dados_512_1000
#===============================================================================
...
#===============================================================================
resultado_gamma_classico_512_1000=rbind(apply(matriz_gamma_hat,2,mean))
resultado_gamma_brock_512_1000=rbind(apply(matriz_gamma_hat_brock,2,mean))
resultado_gamma_wt_512_1000=rbind(apply(matriz_gamma_hat_wt,2,mean))

#===============================================================================
# Resultados - Correlação
#===============================================================================
resultado_rho_classico_512_1000=rbind(apply(matriz_rho_hat,2,mean))
resultado_rho_brock_512_1000=rbind(apply(matriz_rho_hat_brock,2,mean))
resultado_rho_wt_512_1000=rbind(apply(matriz_rho_hat_wt,2,mean))
# 
# setwd("C:/Users/rcfil/OneDrive/Filipe e Wilson/Codigos_R/Estimador rho AR/")
# setwd("C:/Users/fisic/OneDrive/Filipe e Wilson/Codigos_R/Estimador rho AR/")
# save(resultado_rho_classico_512_1000, file = "resultado_rho_classico_512_1000")
# save(resultado_rho_brock_512_1000, file = "resultado_rho_brock_512_1000")
# save(resultado_rho_wt_512_1000, file = "resultado_rho_wt_512_1000")

#===============================================================================
# Correlação real
#===============================================================================
vetor_auxiliar <- c(0:lagmax)
rho_512_1000 <- phi^(vetor_auxiliar)

# save(rho_512_1000, file = "rho_512_1000")
#===============================================================================
# Covariancia real
#===============================================================================
...
mrse_resultado_512_1000<- rbind(rmse(rho_512_1000, resultado_rho_classico_512_1000), 
                                rmse(rho_512_1000, resultado_rho_brock_512_1000), 
                                rmse(rho_512_1000, resultado_rho_wt_512_1000))

bias_resultado_512_1000<- rbind(bias(rho_512_1000, resultado_rho_classico_512_1000), 
                                bias(rho_512_1000, resultado_rho_brock_512_1000), 
                                bias(rho_512_1000, resultado_rho_wt_512_1000))
mrse_resultado_512_1000
bias_resultado_512_1000
# 
# save(mrse_resultado_512_1000, file = "mrse_resultado_512_1000")
# save(bias_resultado_512_1000, file = "bias_resultado_512_1000")
